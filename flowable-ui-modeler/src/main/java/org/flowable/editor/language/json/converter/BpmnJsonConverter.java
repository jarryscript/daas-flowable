...
import com.doublechain.flowable.EventFlowTaskJsonConverter;
import com.doublechain.flowable.EventSequenceFlowJsonConverter;
...
public class BpmnJsonConverter implements EditorJsonConstants, StencilConstants, ActivityProcessor {
    ...
    static {
        ...
        // Event flow task
        EventFlowTaskJsonConverter.fillCustomJsonTypes(convertersToBpmnMap);

        // Event sequence flow
        EventSequenceFlowJsonConverter.fillCustomJsonTypes(convertersToBpmnMap);
    }
    ...
    static {
        ...
        DI_GATEWAY.add(EventFlowTaskJsonConverter.EVENT_FOW_TASK_NAME);
    }
