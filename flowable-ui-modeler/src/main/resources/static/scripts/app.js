...
flowableModeler
  ...
  .config(['$provide', '$routeProvider', '$selectProvider', '$translateProvider', function ($provide, $routeProvider, $selectProvider, $translateProvider) {
    ...
    $routeProvider
    	...
    	//带看代码生成app详情
	    .when('/codegen-apps/:modelId', {
	        templateUrl: appResourceRoot + 'views/custom/codegen-app-definition.html',
	        controller: 'CodeGenAppDefinitionCtrl'
	    })
	    
	    //查看代码生成app
	    .when('/codegen', {
	    	 templateUrl: appResourceRoot + 'views/custom/codegen-app-definitions.html',
	         controller: 'CodeGenAppDefinitionsCtrl'
	    })
	    
	    //查看事件流
	    .when('/event-flows', {
	        templateUrl: appResourceRoot + 'views/custom/event-flows.html',
	        controller: 'EventFlowsCtrl'
	    })
	    
	    //查看事件流详情
	    .when('/event-flows/:modelId', {
            templateUrl: appResourceRoot + 'views/custom/event-flow.html',
            controller: 'EventFlowCtrl'
        })
	    
        //进入事件流编辑
        .when('/event-flow-editor/:modelId', {
            templateUrl: appResourceRoot + 'editor-app/custom/event-flow-editor.html',
            controller: 'EventFlowEditorController'
        })
        //进入事件流app编辑器
        .when('/codegen-app-editor/:modelId', {
            templateUrl: appResourceRoot + 'views/custom/codegen-app-definition-builder.html',
            controller: 'CodeGenAppDefinitionBuilderController'
        })
