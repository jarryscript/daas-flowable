...
angular.module('flowableModeler')
  .controller('EventFlowCtrl', ['$rootScope', '$scope', '$translate', '$http', '$location', '$routeParams','$modal', '$popover', '$timeout', 'appResourceRoot', 'ResourceService',
    ...
    $scope.openEditor = function() {
      if ($scope.model.process) {
        $location.path("/event-flow-editor/" + $scope.model.process.id);
      }
    };
