...
angular.module('flowableModeler')
  .controller('CodeGenAppDefinitionBuilderController', ['$rootScope', '$scope', '$translate', '$http', '$location', '$routeParams', '$modal', '$popover', '$timeout', 
    ...
    $scope.editIncludedModels = function() {
        _internalCreateModal({
            template: 'views/custom/popup/codegen-app-definition-models-included.html?version=' + Date.now(),
            scope: $scope
        }, $modal, $scope);
    };
...
angular.module('flowableModeler')
.controller('CodeGenModelsIncludedPopupCtrl', ['$rootScope', '$scope', '$translate', '$http', '$timeout', '$location', function ($rootScope, $scope, $translate, $http, $timeout, $location) {
...
//        }
    ...
    $scope.loadModels = function() {
        ...
        $http({method: 'GET', url: FLOWABLE.APP_URL.getEventFlowsForAppDefinitionUrl()}).
          success(function(data, status, headers, config) {
