...
angular.module('flowableModeler')
    .controller('EventFlowStencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', '$window', 'editorManager',
        ...
        $scope.editorFactory.promise.then(function () {
            ...
            if (data.namespace == 'http://b3mn.org/stencilset/cmmn1.1#') {
                ...
                quickMenuDefinition = ['UserTask', 'EndNoneEvent', 'ExclusiveGateway', 
                                         ...
                                         'SequenceFlow', 'Association', 'EventSequenceFlow'];
        ...
        $scope.dropCallback = function (event, ui) {
            ...
            if ($scope.quickMenu) {
              ...
              if (shapes && shapes.length == 1) {
                ...
                if (containedStencil.idWithoutNs() !== 'SequenceFlow' && containedStencil.idWithoutNs() !== 'EventSequenceFlow' && containedStencil.idWithoutNs() !== 'Association' && 
