...
angular.module('flowableModeler')
    .controller('EventFlowEditorController', ['$rootScope', '$scope', '$http', '$q', '$routeParams', '$timeout', '$location', '$translate', '$modal', 'editorManager', 'FormBuilderService',
	...
	$http.get(FLOWABLE.URL.getModel(modelId)).then(function (response) {
	    ...
	    if(modelData.data.model.stencilset.namespace == 'http://b3mn.org/stencilset/cmmn1.1#') {
	       ...
	       return $http.get(FLOWABLE.URL.getEventFlowStencilSet());
	    }
